...
const guestMentors: Mentor[] = [
  ...
  { name: "DEBEN RATH", role: "Associate Account Manager at Adobe", experience: "8+ Years Experience", image: debenImg, bgColor: "bg-[#A8C5E8]", employerLogo: "/employers/adobe.svg", employerName: "Adobe" },
