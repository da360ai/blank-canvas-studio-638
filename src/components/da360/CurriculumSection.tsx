...
const specialisations: ModuleData[] = [
  ...
  },
  {
    label: "Specialisation",
    number: 4,
    title: "Specialisation 4 - Digital Photography & Video Engineering",
    sessions: "5 Live Sessions",
    assignments: "2 Assignments",
    caseStudies: "3 Case Study",
    assessments: "1 Assessments",
  ...
  },
  {
    label: "Specialisation",
    number: 5,
    title: "Specialisation 5 - Media Intelligence & Automated Ad Buying",
    sessions: "5 Live Sessions",
    assignments: "2 Assignments",
    caseStudies: "3 Case Study",
    assessments: "1 Assessments",
  ...
  },
  {
    label: "Specialisation",
    number: 7,
    title: "Specialisation 7: Strategic Brand Positioning & Digital PR Mastery",
    sessions: "5 Live Sessions",
    assignments: "2 Assignments",
    caseStudies: "3 Case Study",
    assessments: "1 Assessments",
  ...
  },
  {
    label: "Specialisation",
    number: 8,
    title: "Specialisation 8: Influencer Marketing",
    ...
    subtopics: [
      ...
      "Niche specific influencer",
      "Creator Economy",
      "Influence across Platforms",
      "Cultural Branding",
      "Hook Theory for Visual Content",
      "Collaborations",
      "AI Content Creation",
      "Proposals, Quotations & Deliverables",
      "Pricing & Negotiation",
    ],
  },
  {
    label: "Specialisation",
    number: 9,
    title: "Specialisation 9: Set Up Influencer Agency & Memes Marketing",
  ...
  },
  {
    label: "Specialisation",
    number: 10,
    title: "Specialisation 10: Start Your Own Digital Marketing Agency",
    sessions: "7 Live Sessions",
    assignments: "2 Assignments",
    caseStudies: "3 Case Study",
    assessments: "1 Assessments",
    subtopics: [
      ...
      "Agency Setup and Legal Compliances",
      ...
      "Marketing Presentations Techniques",
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="text-center text-gray-600 mb-[40px] max-w-3xl mx-auto">
          Learn 10 distinct specializations with our 6-month postgraduate leadership certification program with AI
        </p>
